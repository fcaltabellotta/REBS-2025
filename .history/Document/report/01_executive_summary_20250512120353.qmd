...
### Catches
`r Spp` are mainly incidentally caught and retained, and caught mainly by trawl (both bottom and midwater) and hook and line gear in commercial fisheries (@fig-es-landings). Commercial catches ramped up in the late 1960s followed by decreasing catches since the mid-1980s. Recreational catches started to increase in the 1980s, fluctuating over time, with high catches over the last several years (@tbl-es-catches).
