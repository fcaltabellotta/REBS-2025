...
### Catches
`r Spp` are mainly incidentally caught and retained, and caught mainly by trawl (both bottom and midwater) and non-trawl (largely hook and line gear) in commercial fisheries (@fig-es-landings). The non-trawl removals were dominate until the 1960s were trawl-caught `r spp` increased. The 1980s saw the biggest catches from the trawl fishery, but the most recent largest catches come from the at-sea-hake fishery (@tbl-es-catches).
