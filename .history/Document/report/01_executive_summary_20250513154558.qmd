...
catches_es_table |>
  ...
  cols_label(
    "BOTTOM_TRAWL (mt)" = "Trawl (mt)",
    "BOTTOM_TRAWL_DISCARD (mt)" = "Trawl discard (mt)",
    "NON_TRAWL (mt)" = "Non-trawl (mt)",
    "NON_TRAWL_DISCARD (mt)" = "Non-trawl discard (mt)",
    "MIDWATER_TRAWL (mt)" = "Midwater trawl (mt)",
    "AT_SEA_HAKE (mt)" = "At-sea-hake (mt)"
  )|>
  #cols_width(
  #  everything() ~ px(75)
  #) |>
