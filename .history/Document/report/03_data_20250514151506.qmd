...
The fishery length and age data for bottom trawl, non-trawl and midwater trawl fleets were obtained from {{<glossary pacfin>}} Biological Data System (BDS) database. The fishery length and age samples were collected by port samplers.
