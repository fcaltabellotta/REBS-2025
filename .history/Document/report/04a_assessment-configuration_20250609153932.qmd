...
The biggest uncertainty was in the treatment of sex-specific $M$ and the selectivity of the bottom trawl fishery. The combination of these two sources covered the extent of all other sources of uncertainty observed and presented in the sensitivity section of the document. This is different than the uncertainty derived from other processes in the model, such as ageing error, data-weighting, and recruitment estimation. While these 
