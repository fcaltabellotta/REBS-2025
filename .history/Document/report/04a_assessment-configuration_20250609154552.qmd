...
The biggest uncertainty was in the treatment of sex-specific $M$ and the selectivity of the bottom trawl fishery. The combination of these two sources covered the extent of all other sources of uncertainty observed and presented in the sensitivity section of the document. This is different than the uncertainty derived from data treatment, such as ageing error and data-weighting. While these issues cause large uncertainty in stock scale and status estimates, the choice of treatments are based on the common challenge of balancing information in the data within an integrated statistical frameworks to data.
