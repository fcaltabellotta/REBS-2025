...
The estimate of initial recruitment ($lnR_{\0}$) is much higher than the previous assessment (`r round(model_output$parameters[model_output$parameters$Label == "SR_LN(R0)", 3],3)` vs. 6.20). While this is a large increase in the scale of the stock, a value of 
