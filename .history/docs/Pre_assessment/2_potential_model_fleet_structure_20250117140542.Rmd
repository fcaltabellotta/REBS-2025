...
Defining fleets is largely based on differing fleet selectivity (i.e., how the fishery captures fish by length and/or age). In the stock assessment model, selectivity translates into how the removals are taken via length and/or age out of the population. The above three fishery types are distinguished by different fishing activities that result in different selectivities. The fleets are the same as those defined in the 2013 assessment. We plan on using a length-based selectivity curve for all fleets for the current stock assessment model (same as done in the 2013 assessment), as there is no reason to believe significant age-based selectivity is occurring.
