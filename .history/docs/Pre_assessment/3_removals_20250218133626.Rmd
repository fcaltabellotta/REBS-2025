...
![**Figure Ct_compsSO. Comparison of spawning output using updated catches vs using catches from the 2013 Rougheye/Blackspotted Rockfishes assessment.**](C:/Users/Jason.Cope/Documents/Github/REBS-2025/docs/Pre_assessment/plots/catch2_landings_stacked.png){width="75%"} 

\

![**Figure Ct_compsRSS. Comparison of relative spawning output using  updated catches vs using catches from the 2013 Rougheye/Blackspotted Rockfishes assessment.**](C:/Users/Jason.Cope/Documents/Github/REBS-2025/docs/Pre_assessment/plots/catch2_landings_stacked.png){width="75%"} 
