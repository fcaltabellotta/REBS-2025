...
There are some updates in landings by state and fishery, but are overall small (**Figure Ct_All**). Landings over the couple of decades are generally lower than the previous two decades, though more discards are accounted for in the more recent years (**Figure Ct_fleets**). Updating the 2013 stock assessment with these newest catches leads to a small increase in overall spawning stock output (**FIgure Figure Ct_compsSO**), and essentially no change in the relative stock status (**FIgure Figure Ct_compsRSS**).
