...
Comparing the standardized versions (i.e., Z-scores) of the indices shows very similar trends among each model output (**Figure Z_score_Indices**), suggesting little difference in any of the output. The variance in the indices are generally high (**Figure Sd_log_Indices**). 
