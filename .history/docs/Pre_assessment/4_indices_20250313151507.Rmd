...
![**Figure Index_comp_SO. Comparison of spawning output among abundance index treatments from the 2013 and current Rougheye/Blackspotted Rockfishes assessments.**](C:/Users/Jason.Cope/Documents/Github/REBS-2025/docs/Pre_assessment/plots/compare1_spawnbio_indices_comp.png){width="75%"} 

\

![**Figure Index_comp_RSS. Comparison of relative spawning output among abundance index treatments from the 2013 and current Rougheye/Blackspotted Rockfishes assessments.**](C:/Users/Jason.Cope/Documents/Github/REBS-2025/docs/Pre_assessment/plots/compare3_Bratio_indices_comp.png){width="75%"} 
