...
An estimate of maximum age tends to be the most relatable life history parameter to natural mortality. Cope and Hamel (2022) provide the most up-to-date examination of the relationship between maximum age and natural mortality, with a M = 5.4/tmax
