...
Age and length data help provide estimates for important growth parameters. Figure AL_1 has the currently available age and length data, with more ages expected to be completed in the next month. Estimate growth curves are presented in Figure AL_1 and the parameter are provided in Table AL_1. The coefficient of variation (CV) of length by age are shown in Figure AL_2.
