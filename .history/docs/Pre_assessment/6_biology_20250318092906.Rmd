...
We note that the growth values being estimated in our data are notably different than those used in Alaska. For instance, the growth paramters for the BSAI stock is Linf = 51.43, k = 0.06 and t0 = -3.30. This shows a larger size and faster growth of this stock complex than seen in Alaska.
