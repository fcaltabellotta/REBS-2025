...
The model estimates that the stock complex did not exhibit a sharp changes throughout the years, and the dynamics was relatively flat (@fig-es-sb, @fig-es-depl). Estimates for most recent years are shown in @tbl-es-sb. Approximate confidence intervals based on the asymptotic variance estimates show that the uncertainty in the estimated spawning biomass is high.

Fraction unfished shows slight decline in the 1960s with subsequent increase through the early-1980s, following another decrease over the past firty five years. 
