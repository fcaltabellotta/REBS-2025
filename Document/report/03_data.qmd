...
The biomass estimates produced for this assessment using \gls{sdmtmb} are comparable to the biomass estimates produced in the previous benchmark assessment (@fig-WCGBTS_comparision). The index is relatively flat with high variation (@fig-WCGBTS_index).
