...
Discard length composition data for both bottom trawl and non-trawl discard fleets were available from WCGOP. The number of trips and fish sampled for lengths by year are summarized in @tbl-discard_sample_sizes, by discard fleet. 
