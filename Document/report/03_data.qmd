...
The discard amounts of `r Spp` for the period between 2002 and 2023 were obtained from WCGOP by year and fleet (bottom trawl, mid-water trawl and non-trawl).Discard amounts were provided for both the catch share and the non-catch share sector for `r Spp`.  Mid-water trawl discard was not present in non-catch share sector and was very minimal (virtually non-existing) in catch-share sector, with discard rate averaging to 0.1% per year. In the model, no discard was assumed in mid-water trawl fleet. The discarding amounts of `r Spp` within bottom trawl and non-trawl fleets have been relatively low, and were included in the modelas separate fleets. 

##### Bottom Trawl Discard

Bottom trawl discard amounts are provided in Table XX. Bottom trawl discard of `r Spp` for 2002-2011 were made in both catch share and non-catch share sectors, while discards for 2011-2023 period were only made within catch share fleet, and were extremely low.

##### Non-Trawl Discard

Non-trawl discard amounts are provided in Table XX. Non-trawl discard of `r Spp` for 2002-2011 were made in both catch share and non-catch share sectors, while discards for 2011-2023 period were only made within catch share fleet, and were extremely low.
