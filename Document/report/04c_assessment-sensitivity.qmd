...
Likelihood values and estimates of key parameters and derived quantities from each data source removal sensitivity are available in **TABLES XXX** . Additionally, time series of spawning output and relative spawning output are shown in Figures**. Derived quantities relative of all data removal sensitivities to the reference model are summarized in **Figure X**. Generally, the removal of indices of abundance decreased the spawning output and the relative spawning output. ALI WILL ADD MORE HERE... 
