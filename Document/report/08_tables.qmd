...
# Step 1: Read CSV starting from data rows (skip header rows)
management <- read_csv(
  here("Document", "report", "tables_4_doc", "management-performance.csv"),
  skip = 2
)

# Step 2: Manually assign clean column names
...
# Step 3: Format with gt and add tab_spanners
gt_table <- management %>%
  gt(rowname_col = "Year") %>%
  tab_spanner(
