...
mang_perf <- read.csv(here::here("Document","report", "tables_4_doc", "management-performance.csv"),col_names = F)
...
colnames(management_performance) <- combined_headers
...
management_performance <- management_performance %>%
  ...
  gt::tab_spanner(label = "North of 40'10'", 
              columns = vars(`North of 40'10'_OFL (mt)`, `North of 40'10'_ABC (mt)`, `North of 40'10'_ACL (mt)`)) %>%
  gt::tab_spanner(label = "South of 40'10", 
              columns = vars(`South of 40'10_OFL (mt)`, `South of 40'10_ABC (mt)`, `South of 40'10_ACL (mt)`)) %>%
  gt::tab_spanner(label = "Combined", 
              columns = vars(`Combined_OFL (mt)`, `Combined_ABC (mt)`, `Combined_ACL (mt)`)) %>%
  gt::tab_options(
    table.font.size = 12,
    latex.use_longtable = TRUE 
  )
