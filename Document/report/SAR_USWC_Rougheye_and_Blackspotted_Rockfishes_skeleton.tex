...
(\citeproc{ref-hicks_status_2013}{Hicks, Wetzel, and Harms 2013}). This
...
(Table~\ref{tbl-es-spr}, Figure~\ref{fig-es-kobe}).
...
Rougheye/Blackspotted Rockfishes are managed as part of the minor slope
rockfish complex, and there were species specific contributions to the
OFL catch levels set for the complex. The last ten years total dead
catches for Rougheye/Blackspotted Rockfishes against he overfishing
limits (OFLs), the acceptable biological catches (ABCs), the annual
catch limits (ACLs) are shown in Table~\ref{tbl-es-management}.
