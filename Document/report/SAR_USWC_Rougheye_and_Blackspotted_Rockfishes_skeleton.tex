...
\subsection{Bridging analysis, including description of new modeling
approaches and other changes from the last
assessment}\label{bridging-analysis-including-description-of-new-modeling-approaches-and-other-changes-from-the-last-assessment}
...
This is a coastwide, single area model for Rougheye/Blackspotted
Rockfishes, two species that form one management complex.
