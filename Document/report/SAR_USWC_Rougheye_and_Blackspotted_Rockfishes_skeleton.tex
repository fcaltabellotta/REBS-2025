...
\section{\texorpdfstring{This document presents the stock assessment for
the Rougheye (\emph{Sebastes aleutianus}) and Blackspotted
(\emph{Sebastes melanostictus}) rockfishes, two species that form one
management
complex.}{This document presents the stock assessment for the Rougheye (Sebastes aleutianus) and Blackspotted (Sebastes melanostictus) rockfishes, two species that form one management complex.}}\label{this-document-presents-the-stock-assessment-for-the-rougheye-sebastes-aleutianus-and-blackspotted-sebastes-melanostictus-rockfishes-two-species-that-form-one-management-complex.}

Rougheye (\emph{Sebastes aleutianus}) and Blackspotted (\emph{Sebastes
melanostictus}) Rockfishes are two species that form one management
complex. Rougheye Rockfish are a long-lived rockfish named after a
series of 2--10 spines along the lower rim of their eyes. They have also
been called blackthroat or blacktip rockfish Love
...
complex) were instituted in 1983. Ongoing concern that shelf and slope
rockfishes may be undergoing overfishing led the attempt by J. S. Rogers
et al. (\citeproc{ref-rogers_status_1996}{1996}) to describe the status
of most rockfishes contained in the Sebastes complex. \texttt{R\ Spp}
...
3.30.23.1, was used for this assessment. This framework allows the
...
\subsubsection{Area and Fleet Definitions}\label{sec-fleet}
