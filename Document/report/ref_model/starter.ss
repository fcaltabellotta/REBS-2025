...
2025_rougheye_data.ss
2025_rougheye_control.ss
...
1914 # min yr for sdreport outputs (-1 for styr); #_1914
2024 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2024
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1719736321
