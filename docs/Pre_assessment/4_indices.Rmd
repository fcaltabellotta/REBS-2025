...
Comparing the standardized versions (i.e., Z-scores) of the indices shows very similar trends among each model output (**Figure Z_score_Indices**), suggesting little difference in choice of model type. The variance in the indices is generally high (0.3-0.5; **Figure Sd_log_Indices**), suggesting the information content in these indices is low. This is not a surprise given the challenge of sampling these species with trawls.
