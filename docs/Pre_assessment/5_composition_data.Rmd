...
* Why do we see the multi-modal distribution in the two surveys and one discard fleet, especially given it is at a similar size? *Jason - can you point out where you're seeing this multi-modal distribution? are we missing an aggregated age comp plot? (Ali)*
